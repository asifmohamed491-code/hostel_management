...
export const addStudentBaseSchema = z.object({
  ...
  department: z
    ...
    .refine(
      ...
      { message: "Select a valid department short code" }
    ),
  year: z
    .string()
    .min(1, "Year is required")
...
export const addStudentSchema = addStudentBaseSchema.refine(
...
export type AddStudentSchema = z.infer<typeof addStudentBaseSchema>;
